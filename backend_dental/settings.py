"""
Django settings for backend_dental project.
...
SECRET_KEY = 'django-insecure-)^c%lj9i)=%@%vx)85hsib1(f49=%s0ty6sg03hgs+q(8j_@8g'
...
ROOT_URLCONF = 'backend_dental.urls'
...
WSGI_APPLICATION = 'backend_dental.wsgi.application'
